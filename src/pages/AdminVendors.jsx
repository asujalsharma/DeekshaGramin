    ...
    <div className="min-h-screen bg-gray-50 p-3 sm:p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 md:p-6 mb-4 md:mb-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 md:mb-6">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Vendor Management</h1>
              <p className="text-sm md:text-base text-gray-600 mt-1">Manage all registered vendors</p>
            </div>
            <div className="text-left sm:text-right">
              <p className="text-xs md:text-sm text-gray-600">Total Vendors</p>
              <p className="text-2xl md:text-3xl font-bold text-blue-600">{vendors.length}</p>
            </div>
          </div>
      ...
      {selectedVendor && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 sm:p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-3xl w-full p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
